...
<body>
  ...
  <!-- ======= wai Section ======= -->
  <section id="wai" class="d-flex flex-column justify-content-center align-items-center">
    <div class="wai-container" data-aos="fade-in" onclick="triggerAbout()">
      <h1>Kok Wai</h1>
      <p>I'm <span class="typed" data-typed-items="Web Developer, Software Engineer, Backend Developer, Frontend Developer"></span></p>
    </div>
  </section><!-- End wai -->
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span class="age_generator">-</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>Bachelor Degree (Honour)</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span><a href="mailto: kwai8891@gmail.com">kwai8891@gmail.com</a></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Hometown:</strong> <span>Kuala Lumpur, Malaysia</span></li>
                </ul>
              </div>
            </div>
            <p>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      console.log(123123)
      $(".age_generator").text((new Date().getFullYear() - 1991))
    })
